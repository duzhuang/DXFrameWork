import ResManagerTool from "../Utils/ResManagerTool";
...
export default class UIWorkflow implements IUIWorkflow {
    ...
    // 资源管理器
    private m_resManagerTool: ResManagerTool = new ResManagerTool();
