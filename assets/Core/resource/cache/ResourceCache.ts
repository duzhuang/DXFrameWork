...
export default class ResourceCache {
    ...
    public setCacheRes(path: string, asset: cc.Asset): void {
        if (!path || !asset) {
            console.error("ResourceCache cacheRes function path or asset is null");
            return;
        }
    ...
    public getCacheRes(path: string): cc.Asset | undefined {
        if (!path) {
            console.error("ResourceCache getCacheRes function path is null");
            return;
        }
    ...
    public removeCacheRes(path: string): boolean {
        if (!path) {
            console.error("ResourceCache: path is null");
            return false;
        }
